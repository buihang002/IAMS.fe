...
const Navbar = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    <nav
      className={`p-2 shadow bg-white flex justify-start items-center fixed top-0 transition-all duration-300 
      ${
        isOpen ? "ml-64" : "ml-16"
      } right-0 left-0 z-50 border-b border-gray-300`}
    >
      <i className=" bi bi-grid text-gray-500 ml-6 hover:text-gray-800 cursor-pointer "></i>
